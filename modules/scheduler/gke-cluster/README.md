...
| [null_resource.enable_high_scale_checkpointing](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
...
| <a name="input_enable_confidential_storage"></a> [enable\_confidential\_storage](#input\_enable\_confidential\_storage) | Enable Confidential Storage on the cluster nodes. Node boot disks will be encrypted using keys protected by the Confidential VM. | `bool` | `false` | no |
...
| <a name="input_enable_vertical_pod_autoscaling"></a> [enable\_vertical\_pod\_autoscaling](#input\_enable\_vertical\_pod\_autoscaling) | Enable vertical pod autoscaling for the cluster. | `bool` | `false` | no |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_boot_disk_kms_key"></a> [boot\_disk\_kms\_key](#output\_boot\_disk\_kms\_key) | The Customer Managed Encryption Key (CMEK) used to encrypt the boot disks of the GKE nodes. |
...
| <a name="output_enable_confidential_storage"></a> [enable\_confidential\_storage](#output\_enable\_confidential\_storage) | Indicates whether Confidential Storage is enabled at the cluster level. |
